...
#include "../examples/hellogenerate.h"
...
/* Rastro function implementation for 'si' */
void rst_event_si_ptr(rst_buffer_t *ptr, u_int16_t type, const char* s0, u_int32_t i0)
{
...
/* Rastro function implementation for 'si' - fortran support */
void rst_event_si_f_( int16_t *type, const char* s0, int32_t* i0)
{
  rst_event_si ((u_int16_t)* type,  s0, (u_int32_t)* i0);
}
